...
$id = $_GET['id'];
$db = new Database();
$query ="SELECT * FROM add_emp_dental WHERE id=$id";
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <form action="update_security_guard.php?id=<?php echo $id; ?>" method="post">
                        <table>
                            <div class="card" style="margin-left: 20px">
                                <div class="card-header" style="font-size: 35px">
                                    <strong>Sign up</strong> <small>Add Empolyee On Security Guard</small>
                                </div>
                                <tr>
                                    <td>
                                      <?php
                                      if(isset($_POST['delete'])){
                                        $query = "DELETE FROM add_emp_security_guard WHERE id=$id";
                                ...
                                echo "<span style='color:red; margin-left:20px'>".$error."</span>";
                                    ...
                                    echo "<span style='color:green; margin-left:20px'>Data update succssfully.</span>";
                                  }
                                else if(isset($deleteData)){
                                    echo "<span style='color:green; margin-left:20px'>Data Delete succssfully.</span>";
                                  }
                                ?>
                                        <div class="form-group" style="margin-left: 20px; ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input style="width: 1000px;" type="text" name="name" value="<?php echo $getdata['name']?>" />
                                            </div>
                                    ...
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input style="width: 1000px;" type="text" name="category" value="<?php echo $getdata['category']?>" />
                                            </div>
                                            <small class="form-text text-muted">ex. Security Guard</small>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input style="width: 1000px;" type="text" name="phoneNumber" value="<?php echo $getdata['phoneNumber']?>" />
                                            </div>
                                    ...
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <select class="standardSelect" name="location">
                                              <option value="<?php echo $getdata['location']?>"><?php echo $getdata['location']?></option>
                                    ...
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <select class="standardSelect" name="freeSchedule">
                                              <option value="<?php echo $getdata['freeSchedule']?>"><?php echo $getdata['freeSchedule']?></option>
                                ...
                                <td>
                                    ...
                                    <input style="margin-left:20px; margin-bottom: 25px" type="submit" name="delete" value="Delete" />
