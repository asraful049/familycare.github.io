...
$id = $_GET['id'];
$db = new Database();
$query ="SELECT * FROM add_emp_neurology WHERE id=$id";
...
//    $name = mysqli_real_escape_string($db->link, $_POST['name']);
    if ($name==''||$phoneNumber==''||$gender==''||$location==''||$freeSchedule==''){
       ...
       $query ="UPDATE add_emp_neurology
        SET
        name='$name',
        category='$category',
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <form action="update_driver.php?id=<?php echo $id; ?>" method="post">
                        <table>
                            <div class="card" style="margin-left: 20px">
                                <div class="card-header" style="font-size: 35px">
                                    <strong>Sign up</strong> <small>Add Empolyee On Driver</small>
                                </div>
                                <tr>
                                    <td>
                                      <?php
                                      if(isset($_POST['delete'])){
                                        $query = "DELETE FROM add_emp_driver WHERE id=$id";
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <small class="form-text text-muted">ex. Driver</small>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
