...
//    $name = mysqli_real_escape_string($db->link, $_POST['name']);
    if ($name==''||$phoneNumber==''||$gender==''||$location==''||$freeSchedule==''){
        ...
        $query ="INSERT INTO add_emp_dermitology(name, category, phoneNumber, gender, location, freeSchedule) Values('$name', '$category', '$phoneNumber', '$gender', '$location', '$freeSchedule')";
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <form action="add_emp_dermitology.php" method="post">
                        <table>
                            <div class="card" style="margin-left: 20px">
                                <div class="card-header" style="font-size: 35px">
                                    <strong>Sign up</strong> <small>Add Empolyee On Dermitology</small>
                                </div>
                                <tr>
                                    <td>
                                        <?php 
                                    ...
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input style="width: 1000px;" type="text" name="category" value="Dermitology" />
                                            </div>
                                            <small class="form-text text-muted">ex. Dermitology</small>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
