...
$id = $_GET['id'];
$db = new Database();
$query ="SELECT * FROM add_emp_radiology WHERE id=$id";
...
//    $name = mysqli_real_escape_string($db->link, $_POST['name']);
    if ($name==''||$phoneNumber==''||$gender==''||$location==''||$freeSchedule==''){
       ...
       $query ="UPDATE add_emp_radiology
        SET
        name='$name',
        category='$category',
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <form action="update_electrician.php?id=<?php echo $id; ?>" method="post">
                        <table>
                                ...
                                <tr>
                                    <td>
                                      ...
                                      if(isset($_POST['delete'])){
                                        $query = "DELETE FROM add_emp_electrician WHERE id=$id";
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-left: 20px;">
                                            ...
                                            <small class="form-text text-muted">ex. Electricaian</small>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
